  ...
  return (
    <main>
      <div className="flex flex-col gap-12 items-center pt-32 pb-12">
        {/* Our Values Section */}
        <div className="w-15/16 sm:w-2/3">
          <Terminal>
            <div className="flex flex-col sm:flex-row gap-10 items-center">
              ...
              <div>
                ...
                Ganesh is one of the most venerated gods of hinduism, referenced as the{" "}
                <span className="text-terminal">"Destroyer of Obstacles"</span> and the{" "}
                <span className="text-terminal">"Master of Intelect"</span>. Inspired by this divinity and by the growing importance of{" "}
                <span className="text-terminal">Information Security</span> on the context of the current life, some students from ICMC-USP decided to create an extracurricular group in this area.
                <br /><br />
        ...
        <div className="w-15/16 sm:w-2/3 flex flex-col sm:flex-row gap-12">
          <Terminal>
            <div className="text-2xl font-mono font-bold pb-4">
              Group Organization
            </div>
            With the formal start in 2017, Ganesh is organized in{" "}
            <span className="text-terminal">Study and Research Areas</span>, being actually composed by the following active areas: Cryptography, Network and Pentesting, Reverse Engineering, Web Security and Hardware Hacking.
            <br /><br />
          ...
          <Terminal>
            ...
            In addition to the educational objectives, Ganesh also acts as a CTF (Capture the Flag) team, currently the{" "}
            <span className="text-terminal">2nd best national team</span> and{" "}
            <span className="text-terminal">1st in the university category</span>. In these competitions, our members are challenged to find vulnerabilities in different scenarios and find the Flags, specific texts that prove the solution to a challenge.
            <br /><br />
        ...
        <div className="w-15/16 sm:w-2/3">
          <Terminal>
            ...
            To become a member at Ganesh, the only pre-requisite is to participate in our{" "}
            <span className="text-terminal">PIng (Ingress Process)</span> that occurs throughout the first semester of the school year, which happens yearly.
            <br /><br />
