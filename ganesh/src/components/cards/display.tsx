  ...
  return (
    <div className="bg-black/25 shadow-md rounded-lg flex flex-col justify-center items-center backdrop-blur-[6px]">
      ...
      <div className="flex flex-col w-full justify-center gap-2 text-neutral-50 p-5 text-start">
        ...
        <div className="text-xl font-mono font-bold overflow-hidden text-ellipsis h-14 line-clamp-2 flex flex-col justify-center">
          {title}
        </div>
        {summary && (
          <div className="text-xs font-mono overflow-hidden text-ellipsis line-clamp-3">
            {summary}
          </div>
        )}
        <Link
