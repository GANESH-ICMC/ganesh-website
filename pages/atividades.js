...
function App() {
  const [information, setInformation] = useState([
    ...
    {title: "VIM Course", date:"November 25, 2017", description:" Course about the basic usage of the VIM text editor", imagesrc:"/static/images/thumb_vim_course2017.jpg"},
