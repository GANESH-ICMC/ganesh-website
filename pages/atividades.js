...
function App() {
  const [information, setInformation] = useState([
    {title: "PlaceHolder Title", date:"December 1, 2100", description:"Placeholder Description", imagesrc:"/static/images/no_image_available.svg"},
    ...
    {title: "Vacation Course", date:"July 1-5, 2019 ", description:"Vacation Course with theory and practice on various topics on attack and defense techniques.2", imagesrc:"/static/images/no_image_available.svg"},
    ...
    {title: "VIM Course", date:"March 16, 2019", description:" Course about the basic usage of the VIM text editor", imagesrc:"/static/images/no_image_available.svg"},
    {title: "2019 Entry Process", date:"February 25, 2019", description:" The Entry process is composed of a series of classes introducing information security to prepare new members for the group's work", imagesrc:"/static/images/no_image_available.svg"},
    ...
    {title: "WHOAMI movie", date:"October 31, 2018", description:" In a partnership with the PET group we have organized the Screening of the German film \"Whoami\", which has the main themes being information security and privacy", imagesrc:"/static/images/no_image_available.svg"},
    ...
    {title: "Admission Process of 2018", date:"March 23, 2018", description:" The admission process is composed of a series of classes introducing information security to prepare new members for the group's work", imagesrc:"/static/images/no_image_available.svg"},
    ...
    {title: "VIM Course", date:"November 25, 2017", description:" Course about the basic usage of the VIM text editor", imagesrc:"/static/images/no_image_available.svg"},
