        ...
        <div className='container h-full mx-auto flex flex-col items-center text-center py-4'>
          ...
          <div className='flex flex-row flex-wrap justify-center pb-8 md:pb-16'>
            ...
            <div className='w-full md:w-full p-4'>
              ...
              <div className='bg-white rounded-lg shadow-md font-bold flex flex-col items-center justify-center p-8 md:p-16 tracking-wide leading-relaxed' align="left">
              <p>Universidade de São Paulo has an International Cooperation Office whose aim is to promote students, faculty and researchers’ mobility by enhancing cooperation and helping with mobility logistics. Nowadays, USP has over 1,000 international agreements with several institutions all over the world. Students and faculty members enjoy a multicultural environment with people of different cultural backgrounds. Access: <a href="http://www.usp.br/internationaloffice/en/">USP International Office</a> <br/></p>
              </div>
            </div>
          </div>
        </div>
