        ...
        <div className="container mx-auto">
          <div className="flex flex-row-reverse items-center py-8 px-8">
            ...
            <div className="Institute__History_Text text-justify flex-grow">
              <h1 className="text-4xl font-bold">History and Infrastructure</h1>
        ...
        <div className="container mx-auto">
          <div className="flex flex-col items-center py-12 px-12">
            ...
            <div className="Pillars flex flex-row" style={{backgroundColor: "#fff" }}>
              ...
              <div className="Pillars_Text text-justify flex-grow p-8">
                <h1 className="text-4xl font-bold"><Trans i18nKey="icmc:teaching">Teaching</Trans></h1>
            ...
            <div className="Pillars flex flex-row-reverse mt-12" style={{backgroundColor: "#fff" }}>
              ...
              <div className="Pillars_Text text-justify flex-grow p-8">
                <h1 className="text-4xl font-bold"><Trans i18nKey="icmc:research">Research</Trans></h1>
            ...
            <div className="Pillars flex flex-row mt-12" style={{backgroundColor: "#fff" }}>
              ...
              <div className="Pillars_Text text-justify flex-grow p-8">
                <h1 className="text-4xl font-bold"><Trans i18nKey="icmc:cultext">Culture and Extension</Trans></h1>
          ...
          <div className='flex flex-row flex-wrap justify-center pb-8 md:pb-16'>
            <div className='w-full md:w p-4'>
              <div className='bg-white rounded-lg shadow-md font-bold flex flex-col items-center justify-center p-8 md:p-16 tracking-wide leading-relaxed' align="justify">
                  ...
                  <p> The Instituto de Ciências Matemáticas e de Computação (ICMC) at University of São Paulo (USP) is one of the most important Brazilian institutions in the fields of Computer Science, Mathematics, Applied Mathematics and Statistics.
                  <br/>       
                  <br/> 
                  </p>
                  <p>
              ...
              <div className='bg-white rounded-lg shadow-md font-bold flex flex-col items-center justify-center md:p-16 tracking-wide leading-relaxed' className="video-container">
            ...
            <div className='w-full md:w-full p-4'>
              <div className='bg-white rounded-lg shadow-md font-bold flex flex-col items-center justify-center p-8 md:p-16 tracking-wide leading-relaxed' align="justify">
                  ...
                  <p>The Institute was created in 1971 and actually occupies an area of 18,000 square meters. It has approximately 2,000 students divided into eight undergraduate courses and five graduate programs, including a staff of approximately 150 faculty members and 120 technical administrative staff. The ICMC's student presents a dynamic and solid formation that prepares and distinguishes him or her in their professional careers.
                  <br/>       
                  <br/>  </p>
                  ...
                  <br/>       
                  <br/>  </p>
                  <p>In addition, the institute can count on the infrastructure of the USP campus in São Carlos, which offers facilities such as a restaurant, lodging, transportation between the campuses, medical and dental services, a day care center and a sports center.
                  <br/>       
                  <br/>  </p>
                  <p>It is located at the USP campus in São Carlos, 230 km away from the city of São Paulo. The city is known as the "Capital of Science and Technology" because of the universities and researchers we have here and also as the "City of Climate" because it is common to experience the four seasons of the year on the same day; cold in the morning, very hot in the middle of the afternoon, rain at the end of the day and a cool breeze at night. It is also the first city in South America in terms of the number of PhD holders per inhabitant, and has an excellent track record in innovation and developing high technology. There are two important public universities (USP and the Federal University of São Carlos - UFSCar) in the city, as well as a private university, a technology faculty, two Embrapa research centers, two technology parks and various technology-based companies. <br/>       
                  <br/> </p>
                  </Trans>
              </div>
            </div>
