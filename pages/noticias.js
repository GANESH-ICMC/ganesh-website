...
function App() {
  const [information, setInformation] = useState([
    ...
    {title: "WHOAMI movie", date:"October 31, 2018", description:" In a partnership with the PET group we have organized the Screening of the German film \"Whoami\", which has the main themes being information security and privacy", imagesrc:"/static/images/whoami.jpg"},
