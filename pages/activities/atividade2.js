...
const atividade2 = () => (
  <React.Fragment>
    <Head
      title="Ganesh - ATIVIDADE COM FOTOS NO MEIO"
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex bg-white my-4 rounded-lg shadow-md">
          <div className="py-2 pr-2 xl:py-4 xl:pr-4">
            ...
            ATIVIDADE COM FOTOS NO MEIO
            </h2>
            <h3 className="news-date text-xs pb-2 xl:pb-4">05/12/1999</h3>
            <p>
              Se você notar, essa é uma atividade com layout de uma foto no meio do texto. Se vc clicar na foto, ela abre maior.
            </p>
            <p>
